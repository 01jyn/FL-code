...
#Project_Path = r'/root/Robust_FL/Robust_FL-master/'
Project_Path = r'/home/jxj/Robust_FL-Master-cf/Robust_FL-master/Robust_FL-master'
...
def init_logs(log_level=logging.INFO,log_path = Project_Path+'Logs/',sub_name=None):
    ...
    if sub_name == None:
        log_name = log_path + filename + '_' + sys.argv[1] + '_02_pairnoise.log'
    else:
        log_name = log_path + filename + '_' + sub_name + '_' + sys.argv[1] +'_02_pairnoise.log'
    logfile = log_name
